	...
	var ViewerCore = function (_React$Component) {
	    ...
	    function ViewerCore(props) {
	        ...
	        _this.loadImgSuccess = function (activeImage, imgWidth, imgHeight, isNewImage) {
	            ...
	            var left = Math.floor((_this.containerWidth - width) / 2);
	            var top = Math.floor((_this.containerHeight - height - _this.footerHeight) / 2);
	        ...
	        _this.handleZoom = function (targetX, targetY, direct, scale) {
	            ...
	            if (_this.state.width === 0) {
	                ...
	                left = Math.floor((_this.containerWidth - imgWidth) / 2);
	                top = Math.floor((_this.containerHeight - _this.footerHeight - imgHeight) / 2);
	                ...
	                top = Math.floor(_this.state.top + -direct * diffY / _this.state.scaleX * scale * directX);
	                left = Math.floor(_this.state.left + -direct * diffX / _this.state.scaleY * scale * directY);
	        ...
	        _this.handleResize = function () {
	            ...
	            if (_this.props.visible) {
	                var left = Math.floor((_this.containerWidth - _this.state.width) / 2);
	                var top = Math.floor((_this.containerHeight - _this.state.height - _this.footerHeight) / 2);
	                _this.setState({
	                    left: left,
	                    top: top
	                });
